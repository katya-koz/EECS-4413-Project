...
//    @BeforeEach
//    void setup() {
//        cat0 = new CatalogueItem("Click! DVD", LocalDateTime.now().plusDays(10));
//        cat1 = new CatalogueItem("50 First Dates DVD", LocalDateTime.now().plusDays(2));
//        cat2 = new CatalogueItem( "The Devil Wears Prada DVD", LocalDateTime.now().minusDays(3));
//        cat3 = new CatalogueItem( "A shirt", LocalDateTime.now().plusDays(1));
//        cat4 = new CatalogueItem("A pair of pants", LocalDateTime.now().plusDays(4));
//    }
//
//    @Test
