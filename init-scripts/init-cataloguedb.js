...
db.createUser({
  user: "root",
  pwd: "secret",
  roles: [{ role: "readWrite", db: "catalogueDB" }],
});
...
db.items.insertMany([
  ...
  },
  {
    ...
    itemDescription:
      "Elegant vintage pocket watch, fully functional and collectible.",
    shippingDays: 10,
    isActive: true,
  },
  {
    ...
    itemDescription:
      "First edition comic book, mint condition, collector's item.",
    shippingDays: 7,
    isActive: true,
  },
  {
